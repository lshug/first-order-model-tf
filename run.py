...
parser.add_argument("--model", action="store", type=str, default="vox", nargs=1, help="model name")
parser.add_argument("--source_image", action="store", type=str, nargs=1, default="example/source.png", help="source image path for file datamode")
